"""
This module contains the main integration function for simulating the 
2D Hamiltonian Mean Field (HMF) system.

Key Features:
- Handles transformations between Cover 1 and Cover 2 coordinate systems.
- Tracks energy conservation and particle trajectories over time.
- Outputs positions, velocities, energies, and time data for analysis.

Dependencies:
- coordinate_transformations.py: For coordinate transformations.
...
def integration(N,Nt,h,alpha,M,phi_0,theta_0,dphi_0,dtheta_0): 
  ...
  """
    Args:
        ...
        phi_0 (numpy.ndarray): Initial longitudes in Cover 1.
        theta_0 (numpy.ndarray): Initial latitudes in Cover 1.
        dphi_0 (numpy.ndarray): Initial velocities in phi direction.
        dtheta_0 (numpy.ndarray): Initial velocities in theta direction.

    Returns:
        tuple: 
            - phi_vals (numpy.ndarray): Longitudes over time in Cover 1.
            - theta_vals (numpy.ndarray): Latitudes over time in Cover 1.
            - dphi_vals (numpy.ndarray): Velocities in phi direction over time.
            - dtheta_vals (numpy.ndarray): Velocities in theta direction over time.
            - K (numpy.ndarray): Kinetic energy at each time step.
            - U (numpy.ndarray): Potential energy at each time step.
            - time (numpy.ndarray): Time array for all time steps.
    """
